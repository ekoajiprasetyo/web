    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'rows'         => 3,
                'required'     => 1,
                'instructions' => 'Penjelasan singkat tentang program ini (2-3 kalimat). Ditampilkan di front page.',
                'new_lines'    => 'br',
            ),
            array(
                'key'          => 'field_sp_desc_long',
                'label'        => 'Deskripsi Lengkap',
                'name'         => 'sp_desc_long',
                'type'         => 'textarea',
                'rows'         => 6,
                'required'     => 0,
                'instructions' => 'Penjabaran lengkap program untuk halaman detail "Program Unggulan". Boleh beberapa paragraf.',
                'new_lines'    => 'wpautop',
            ),
            array(
                'key'          => 'field_sp_highlights',
                'label'        => 'Poin Unggulan',
                'name'         => 'sp_highlights',
                'type'         => 'textarea',
                'rows'         => 5,
                'required'     => 0,
                'instructions' => 'Poin-poin keunggulan program, satu baris satu poin. Contoh:<br><code>UKS aktif dan berstandar nasional</code><br><code>Kantin bergizi bersertifikat</code>',
                'new_lines'    => '',
            ),
